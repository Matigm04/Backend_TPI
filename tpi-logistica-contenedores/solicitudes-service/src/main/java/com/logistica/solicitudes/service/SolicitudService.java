...
public class SolicitudService {
    ...
    public SolicitudResponseDTO crearSolicitud(SolicitudRequestDTO request) {
        ...
        Contenedor contenedor = Contenedor.builder()
            ...
            .largoM(request.getContenedor().getLargoM())
            .anchoM(request.getContenedor().getAnchoM())
            .altoM(request.getContenedor().getAltoM())
            .estado(request.getContenedor().getEstado())
            .descripcion(request.getContenedor().getDescripcion())
            .clienteId(request.getContenedor().getClienteId())
    ...
    private SolicitudResponseDTO mapToResponseDTO(Solicitud solicitud) {
        return SolicitudResponseDTO.builder()
            ...
            .ubicacionOrigen(solicitud.getUbicacionOrigen())
            .ubicacionDestino(solicitud.getUbicacionDestino())
            .estado(solicitud.getEstado())
            .costoEstimado(solicitud.getCostoEstimado())
            .tiempoEstimadoHoras(solicitud.getTiempoEstimadoHoras())
            ...
            .tarifaId(solicitud.getTarifaId())
    ...
    private ContenedorResponseDTO mapContenedorToResponseDTO(Contenedor contenedor) {
        return ContenedorResponseDTO.builder()
            ...
            .clienteId(contenedor.getClienteId())
